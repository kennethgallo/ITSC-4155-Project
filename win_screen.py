...
class WinScreen:
    def __init__(self, window_width, window_height, display_surface, final_score, enemies_defeated):
        ...
        self.title_rect = self.title_text.get_rect(center=(window_width / 2, window_height / 5))
        ...
        self.score_rect = self.score_text.get_rect(center=(window_width / 2, window_height / 4))

        # Enemies Defeated Display
        self.enemies_defeated_font = pygame.font.Font(None, 30)
        self.enemies_defeated = enemies_defeated
        self.enemies_defeated_text = self.score_font.render('Enemies Defeated: {}'.format(self.enemies_defeated), True, 'White')
        self.enemies_defeated_rect = self.score_text.get_rect(center=(window_width / 2, window_height / 3))

        # Quit button
        self.quit_button = Button('Quit', 'Black', 'White', 200, 100)
        self.quit_button.rect.center = (window_width / 2, window_height / 2)
