...
class EnemySpawner:
    ...
    def spawn_enemies(self, curr_round):
        ...
        num_enemies = curr_round * 6  # six enemies more each round for now
        ...
        for index in range(num_enemies):
            ...
            if index % 6 >= 4:  # if last two enemies in loop of 6
            ...
            if enemy_type == 'melee':
                enemy = Enemy(index, 50 * curr_round, x_pos, y_pos, self.all_sprites, self.enemy_projectiles, 'melee')
            else:
                enemy = Enemy(index, 50 * curr_round, x_pos, y_pos, self.all_sprites, self.enemy_projectiles, 'projectile')
